...
function ModalDelete({ openModalDelete, idDelete, handleCloseDelete, style, setVarRefeshPage, varRefeshPage }) {
    ...
    const onBtnConfirmDeleteClick = () => {
        ...
        fetch("http://localhost:8000/orders/" + idDelete, { method: 'DELETE' })
            // .then(async response => {
    ...
    return (
        <>
            <Modal
                ...
                aria-describedby="modal-delete-order"
            >
                <Box sx={style}>
                    ...
                    <Grid container className="mt-2">
                        <Grid item xs={12} align="center">
                            <h4>Bạn có thật sự muốn xóa Đơn hàng có ID:
                                <h4 style={{ color: "red", marginTop: "20px" }}>{idDelete} ? </h4>
                            </h4>
                        </Grid>
                    </Grid>
